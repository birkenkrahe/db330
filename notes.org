...
** Introduction to Org-mode for SQLite

   The respective [[https://orgmode.org/worg/org-contrib/babel/languages/ob-doc-sqlite.html][section in the Orgmode-Manual]] is short and contains
   many examples for you to try out.
   
** "Be the shell!": in-class assignment

   You can perform all of these commands inside an Org-mode file to
   keep it, or on the command line, if you don't care about losing it.
