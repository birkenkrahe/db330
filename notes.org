...
* SQLite lab session, test 1 results - w5s8 (02/10/22)
  ...
  * See [[https://github.com/birkenkrahe/db330/blob/main/FAQ.org#control-question-test-1-on-cloud-services][the FAQ]] for a question on the problem of "decreasing control"
    ...
    the customer, more relevant for the provider[fn:7].

  * I think the results are actually very decent - > 75%% is a
    good result - better next time!
    #+caption: Test 1 results (preliminary)
    #+attr_html: :width 500px
    [[./img/test_1_stats.png]]

  * What surprised me most was that many of you did not use the
    available time. The stats don't show this number[fn:6], but a
    quick glance does not seem to reveal any clear pattern.

  * Study and test taking habits: we'll discuss these next week! I may
    have disqualified myself personally by confessing that, as a
    student, I never had to take any tests (in physics, you solve
    problems instead and turn them in for grading), but I have
    developed and administered lots of exams.
...
[fn:7]If you had the order SaaS-Paas-IaaS correct in either direction,
you got the full point for this question.

[fn:6]This is a nice R project that I'm pursuing right now: loading
