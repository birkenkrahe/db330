...
** Objectives
   ...
   * [ ] Understand how to export table data
   * [ ] Understand how to import data, especially CSV files
   * [ ] Know how to delete tables
   * [ ] Understand unique constraints (PRIMARY KEY)
   * [ ] Remaining DML commands: UPDATE TABLE
   * [ ] Remaining DDL commands: ALTER TABLE
   * [ ] NULL values and how to enforce them
...
** SQLite Code Blocks in Org Mode
   ...
   * Do you remember what tangling and weaving means?
   ...
   #+caption: literate programming - "foo.w" is the Org-mode file
   #+attr_html: :width 600px
   [[./img/cweb.png]]
