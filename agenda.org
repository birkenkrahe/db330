...
** ~CASE~, SQL subqueries and the pipeline  
** Visualize with R via Kaggle

   If there is time, we'll take a look at visualizing some of the
   relationships using R or Python.

   * [[https://www.kaggle.com/datasets/hugomathien/soccer][Kaggle database link]]
   * [[https://www.kaggle.com/code/scratchpad/notebook1f7ce72033/edit][Kaggle notebook link]]



** Plans for the last weeks of term (Schoology update)

   * On *Tuesday, April 26*, we will review NoSQL and graph databases
     (this is also the deadline for the [[https://lyon.schoology.com/assignment/5897254286][video-based assignment]]).
   * On *Thursday, April 28*, we will review the 3 quizzes for /test 3/
     (scheduled for online submission Thursday 28-April 3 pm am to
     Friday 29-April 3 pm).
