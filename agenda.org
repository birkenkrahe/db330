...
* SELECT round-up: ORDER BY, GROUP BY, LIMIT, OFFSET - w8s15 (10-Mar)
...
* Quiz review, project review - w9s16 (15-Mar)
...
*** FINDING THE NUMBER OF DISTINCT COUNTRIES
    ...
    * [ ] DISTINCT inside or outside of COUNT()?
    ...
    #+begin_quote
    In [[distinct1]], no column has been selected so the
    operator/function ~DISTINCT~ has nothing to act upon.

    In [[distinct2]], the number of unique countries is selected -
    ~DISTINCT country_name~ throws away any rows with the same
    value in ~country_name~.
    #+end_quote
...
*** DISCUSSION
    ...
    * [ ] What's left out in this analysis of debt?

    * [ ] Has the exercise changed your point of view?
