...
* ERD and the Relational Model (12-Apr)
  ...
  * [ ] Review ERD practice exercise ([[https://lyon.schoology.com/assignment/5853760880/info][Schoology]])
  * [ ] ERD II: keys & bridge tables (practice/ [[https://github.com/birkenkrahe/db330/tree/main/practice][in GitHub]])
  * [ ] ERD practice exercise ([[https://drive.google.com/drive/folders/1_7g2QHnAEc_4pQki6r-KRJYGcl_mdq3Y?usp=sharing][GDrive]])
...
* NEXT ERD practice / Intermediate SQL lab: CASE (14-Apr)
  ...
  * [ ] Dropped last two DataCamp assignments - one mandatory
  ...
  * [ ] Finish the ERD exercise from last Tuesday if you have not
    already done so. Ask for my help if you can't do it!

  * [ ] Everybody else, please work on Intermediate SQL notebook
