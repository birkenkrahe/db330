...
* NEXT Project && (MongoDB (NoSQL DB) && Final Exam Review || RSQLite) (3-May)

** Bonus DataCamp project
...
* Final exam (Thu 5-May 6pm-8pm)

  | COURSE NO | MEETS    | TIME                    | ROOM      |
  |-----------+----------+-------------------------+-----------|
  | *CSC 330*   | *TR 1.00p* | *Sat 7-May 1.00p - 3.00p* | *Lyon 104*  |
  |-----------+----------+-------------------------+-----------|
