...
** Overview
   ...
   | Assignment | [[https://h5p.org/node/84879][Inside Google's Data Center]] (Thu)            |
   |------------+----------------------------------------------|
...
** Objectives
   ...
   * [ ] Review db foundation and GNU Emacs (quiz 2)

   * [ ] Review introduction to cloud computing (DataCamp 1)

   * [ ] Understand GNU Emacs Org-mode

   * [ ] Know how to create a literate Org-mode file

   * [ ] Know how to run a literate Org-mode file
