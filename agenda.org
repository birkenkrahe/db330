...
* NEXT SQLite introduction - w5s7 - February 8, 2022
** Overview
...
** TODO Practice: SQLite Basics (cont'd)
   DEADLINE: <2022-02-08 Tue>

   * We last looked at entering SQLite ([[file:notes.org::Captain's Log Stardate 99687.04][notes]])

   * Today, we'll work with an [[~/Documents/GitHub/admin/spring22/db330/sqlite.org::README][interactive Org-notebook]]
