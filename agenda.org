...
* SELECT round-up: JOINs, WHERE - w9s14 (8-Mar)
** Agenda
...
* SELECT round-up: ORDER BY, GROUP BY, LIMIT, OFFSET - w9s15 (10-Mar)
...
* Relational database thinking - w11s18 (29-Mar)
  ...
  * [ ] Group exercise: relational database thinking
  * [ ] Object-relational mapping in editor.ponyorm.com
...
* SELECT lab with the foods database (31-Mar)

  * [ ] Crowfoot notation and ERD intro
  * [ ] [[https://editor.ponyorm.com/user/birkenkrahe/food/designer][foods database in ponyorm]]
