...
** Objectives
   ...
   * [ ] Interactive SQLite notebook tutorial
   * [ ] SELECT notebook 1
   * [ ] Lecture: SELECT with examples
   
** SQLite Code Blocks in Org Mode

   * Do you remember what Org-mode is?
   * Do you remember what tangling and weaving means?
   * [[file:~/Documents/GitHub/org/FAQ.org::literate programming][See FAQs]] ([[https://github.com/birkenkrahe/org/blob/master/FAQ.org#what-does-weaving-doc-and-tangling-c-code-from-org-mode-mean][GitHub]])
...
** Download practice material
   ...
   * Download from [[https://lyon.schoology.com/course/5516220926/materials?f=572696570][Schoology folder Notebooks]]:
...
* SELECT round-up: JOINs, WHERE - w8s14 (8-Mar)
** Agenda
...
* SELECT round-up: ORDER BY, GROUP BY - w8s15 (10-Mar)

  * [ ] Finish SELECT workbook [[https://drive.google.com/drive/u/0/folders/1_7g2QHnAEc_4pQki6r-KRJYGcl_mdq3Y][SELECT_roundup.org (GDrive)]]
  * [ ] Prepare DataCamp project: [[https://projects.datacamp.com/projects/571][Introductory SQL project]]
